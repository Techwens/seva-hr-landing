...
import {api} from "../lib/api.helper.js";
...
const OnboardingHeader = ({formData, organizationTypes, industries, states, currentDomain}) => {
  ...
  return (
    <Card className="mb-6 shadow-md border border-gray-200 bg-linear-to-br from-white to-gray-50">
      <CardContent className="pt-6 pb-6">
        <div className="flex items-start justify-between flex-col lg:flex-row gap-6">
          <div className="flex items-center gap-4 flex-1">
            <Avatar className="h-20 w-20 bg-linear-to-br from-blue-500 to-blue-600 shadow-lg">
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-50 to-gray-100 p-6">
      <div className="max-w-5xl mx-auto space-y-6">
        <Card
          className="text-center shadow-xl border-0 bg-linear-to-br from-green-50 via-blue-50 to-purple-50 overflow-hidden relative">
          ...
          <CardContent className="py-16 relative z-10">
            ...
            <h1
              className="text-5xl font-extrabold mb-4 bg-linear-to-r from-green-600 to-blue-600 bg-clip-text text-transparent">
          ...
          <Card className="shadow-lg border-gray-200">
            ...
            <CardContent className="pt-8 pb-8">
              <div className="text-center space-y-4">
                ...
                <div className="bg-linear-to-r from-purple-100 to-pink-100 rounded-xl p-5 border-2 border-purple-200">
        ...
        <Card className="shadow-lg border-gray-200">
          <CardHeader className="bg-linear-to-r from-orange-50 to-yellow-50 border-b">
            <CardTitle className="flex items-center gap-2 text-gray-900">
            ...
            <div className="space-y-6">
              {nextSteps.map((step, index) => (
                <div key={index} className="flex gap-4 items-start">
                  <div className={`mt-1 ${index === 0 ? 'text-orange-500' : 'text-gray-300'} shrink-0`}>
                    {step.icon}
                  </div>
        ...
        <Card className="shadow-lg border-gray-200">
          <CardHeader className="bg-linear-to-r from-green-50 to-teal-50 border-b">
            <CardTitle className="flex items-center gap-2 text-gray-900">
          ...
          <CardContent className="pt-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div
                className="flex items-start gap-4 p-5 bg-linear-to-br from-blue-50 to-blue-100 rounded-xl border border-blue-200">
              ...
              <div
                className="flex items-start gap-4 p-5 bg-linear-to-br from-green-50 to-green-100 rounded-xl border border-green-200">
          ...
          <div className="space-y-6">
            ...
            <div className="flex justify-end gap-4 pt-6 border-t-2 border-gray-200">
              ...
              <Button
                ...
                className="px-12 h-11 font-semibold bg-linear-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 shadow-lg disabled:opacity-50"
              >
                {loading ? (
                  <>
