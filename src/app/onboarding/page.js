        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div>
            <div>
                      ...
                      <div className="flex">
                        <div className="relative flex-1">
                          <Input
                            ...
                            className={`rounded-r-none border-r-0 h-11 ${errors.slug && touched.slug ? 'border-red-500' : slugAvailable === true ? 'border-green-500' : ''
                              }`}
                            maxLength={30}
                          />
                          {slugChecking && (
              ...
              {/* Legal Information */}
              <Card>
                <CardHeader style={{ background: "#faefff" }}>
                  <CardTitle className="flex items-center gap-2 text-gray-900">
              ...
              {/* Address */}
              <Card>
                <CardHeader style={{ background: "#effff4" }}>
                  <CardTitle>
                    <Home />
                    Address
                  </CardTitle>
                      ...
                      {formData.password && (
                        <div className="space-y-2 mt-3">
                          <div className="flex justify-between text-sm">
                            ...
                            <span className={`font-semibold ${passwordStrength < 40 ? 'text-red-600' :
