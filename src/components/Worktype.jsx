...
// Reusable checkmark icon for points list
const CheckIcon = () => (
...
// Feature icons with proper JSX attributes
const TimeIcon = () => (
  <svg width="41" height="41" viewBox="0 0 41 41" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    <defs>
            ...
            {featureData.map((item, index) => {
              ...
              return (
                <FeatureCard key={index}>
                  <Step className="step" aria-label={`Step ${item.step}`}>{item.step}</Step>
